...
curl -L -o libs/jakarta.validation-api-3.0.2.jar https://repo1.maven.org/maven2/jakarta/validation/jakarta.validation-api/3.0.2/jakarta.validation-api-3.0.2.jar
